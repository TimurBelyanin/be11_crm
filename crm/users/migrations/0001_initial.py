    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ImageField(blank=True, null=True, upload_to='profile_pics/', verbose_name='Изображение профиля')),
                ('usdt_trc20', models.CharField(blank=True, max_length=42, null=True, verbose_name='Криптокошелек')),
